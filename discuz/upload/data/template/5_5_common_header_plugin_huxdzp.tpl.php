...
0
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_common.htm', 1419912511, '5', './data/template/5_5_common_header_plugin_huxdzp.tpl.php', './template/an_paly', 'common/header_plugin_huxdzp')
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_qmenu.htm', 1419912511, '5', './data/template/5_5_common_header_plugin_huxdzp.tpl.php', './template/an_paly', 'common/header_plugin_huxdzp')
;?>

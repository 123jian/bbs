...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1419772730, '2', './data/template/2_2_member_login.tpl.php', './template/an_paly', 'member/login')

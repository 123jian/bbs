...
0
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_common.htm', 1419984794, '5', './data/template/5_5_common_header_forum_attachment.tpl.php', './template/an_paly', 'common/header_forum_attachment')
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_qmenu.htm', 1419984794, '5', './data/template/5_5_common_header_forum_attachment.tpl.php', './template/an_paly', 'common/header_forum_attachment')
;?>
...
<?php } ?>
       <script src="template/an_paly/style/js/jquery.min.js" type="text/javascript" type="text/javascript"></script> 
   <script src="template/an_paly/style/js/slider.js" type="text/javascript" type="text/javascript"></script> 
   <link rel="stylesheet" type="text/css" href="template/an_paly/style/css/style.css" media="all">
</head>
...
<?php if(!empty($_G['setting']['pluginhooks']['global_nav_extra'])) echo $_G['setting']['pluginhooks']['global_nav_extra'];?>
                    <script src="template/an_paly/style/js/nav.js" type="text/javascript" type="text/javascript" ></script>
</div>

...
0
|| checktplrefresh('./template/an_paly/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1419929227, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/an_paly', 'forum/forumdisplay')
|| checktplrefresh('./template/an_paly/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1419929227, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/an_paly', 'forum/forumdisplay')
|| checktplrefresh('./template/an_paly/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1419929227, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/an_paly', 'forum/forumdisplay')
|| checktplrefresh('./template/an_paly/forum/forumdisplay.htm', './template/an_paly/forum/forumdisplay_list.htm', 1419929227, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/an_paly', 'forum/forumdisplay')
|| checktplrefresh('./template/an_paly/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1419929227, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/an_paly', 'forum/forumdisplay')
|| checktplrefresh('./template/an_paly/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1419929227, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/an_paly', 'forum/forumdisplay')
|| checktplrefresh('./template/an_paly/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1419929227, 'diy', './data/template/5_diy_forum_forumdisplay.tpl.php', './template/an_paly', 'forum/forumdisplay')
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_g['forum']['allowspecialonly'] && empty($_g['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><img src="<?php echo $_G['style']['styleimgdir'];?>/pn_post.png" alt="发新帖" /></a><?php } ?>
...
<?php if(empty($_G['forum']['sortmode'])) { ?><div id="threadlist" class="tl bm bmw<?php if(!(($_G['forum']['threadtypes'] && $_G['forum']['threadtypes']['listable']) || count($_G['forum']['threadsorts']['types']) > 0)) { ?> addradius<?php } ?>" style="position: relative;">

...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1419903440, '5', './data/template/5_5_member_register.tpl.php', './template/an_paly', 'member/register')

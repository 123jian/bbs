...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1419918291, '5', './data/template/5_5_member_login.tpl.php', './template/an_paly', 'member/login')

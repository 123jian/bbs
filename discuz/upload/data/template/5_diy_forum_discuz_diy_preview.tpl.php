...
block_get('9,41,42,24,23');?><?php include template('common/header'); ?><script src="template/an_paly/style/js/jquery-1.js" type="text/javascript"></script>
...
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framed2q1R8" class="frame move-span cl frame-1"><div id="framed2q1R8_left" class="column frame-1-c"><div id="framed2q1R8_left_temp" class="move-span temp"></div><?php block_display('9');?></div></div><div id="framez85WVC" class="frame move-span cl frame-1"><div id="framez85WVC_left" class="column frame-1-c"><div id="framez85WVC_left_temp" class="move-span temp"></div><div id="framen29fDU" class="frame move-span cl frame-1-1-1"><div class="title frame-title"><span class="titletext">1-1-1框架</span></div><div id="framen29fDU_left" class="column frame-1-1-1-l"><div id="framen29fDU_left_temp" class="move-span temp"></div><?php block_display('41');?></div><div id="framen29fDU_center" class="column frame-1-1-1-c"><div id="framen29fDU_center_temp" class="move-span temp"></div><?php block_display('42');?></div><div id="framen29fDU_right" class="column frame-1-1-1-r"><div id="framen29fDU_right_temp" class="move-span temp"></div></div></div><?php block_display('24');?><div id="frameJYDd1V" class="frame move-span cl frame-1-1"><div class="title frame-title"><span class="titletext">1-1框架</span></div><div id="frameJYDd1V_left" class="column frame-1-1-l"><div id="frameJYDd1V_left_temp" class="move-span temp"></div><?php block_display('23');?></div><div id="frameJYDd1V_center" class="column frame-1-1-r"><div id="frameJYDd1V_center_temp" class="move-span temp"></div></div></div></div></div></div><!--[/diy]-->
</div>
<?php } ?>

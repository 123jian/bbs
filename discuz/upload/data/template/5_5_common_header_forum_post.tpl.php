...
0
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_common.htm', 1419564190, '5', './data/template/5_5_common_header_forum_post.tpl.php', './template/an_paly', 'common/header_forum_post')
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_qmenu.htm', 1419564190, '5', './data/template/5_5_common_header_forum_post.tpl.php', './template/an_paly', 'common/header_forum_post')
;?>

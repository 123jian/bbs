...
0
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_common.htm', 1419915567, '5', './data/template/5_5_common_header_member_logging.tpl.php', './template/an_paly', 'common/header_member_logging')
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_qmenu.htm', 1419915567, '5', './data/template/5_5_common_header_member_logging.tpl.php', './template/an_paly', 'common/header_member_logging')
;?>

...
0
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_common.htm', 1419772718, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/an_paly', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_qmenu.htm', 1419772718, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/an_paly', 'common/header_forum_forumdisplay')
;?>

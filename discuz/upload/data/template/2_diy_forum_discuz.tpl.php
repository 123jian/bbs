<<<<<<< HEAD:discuz/upload/data/template/5_diy_forum_discuz.tpl.php
...
=======
<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><script src="template/an_paly/style/js/jquery-1.js" type="text/javascript"></script>
<script src="template/an_paly/style/js/jquery_pic.js" type="text/javascript"></script>
<style type="text/css">
.specials-pic-text, .specials-list li a, .specials-text-bg{ width:220px}
</style>
...
>>>>>>> 4b3e7c98909ceacb2cb3df2fed6e87d89d7a5ae6:discuz/upload/data/template/2_diy_forum_discuz.tpl.php

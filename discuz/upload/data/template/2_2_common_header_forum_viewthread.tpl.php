...
0
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_common.htm', 1419772813, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/an_paly', 'common/header_forum_viewthread')
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_qmenu.htm', 1419772813, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/an_paly', 'common/header_forum_viewthread')
;?>

...
0
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_common.htm', 1419638628, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/an_paly', 'common/header_home_space')
|| checktplrefresh('./template/an_paly/common/header.htm', './template/default/common/header_qmenu.htm', 1419638628, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/an_paly', 'common/header_home_space')
;?>

...
<!--{subtemplate common/header_common}-->
	...
	<!--{/if}-->
<script type="text/javascript" src="template/mobanbus_iqy/mobanbus_st/js/mobanbus_pace.js"></script>
<script type="text/javascript" src="template/mobanbus_iqy/mobanbus_st/js/jQuery.js"></script>
...
<!--导航结束-->
	...
	<!--{/if}-->
<!--{if $_G['basescript'] == 'portal' && CURMODULE == 'index'}--><!--{else}--><div id="wp" class="wp"><!--{/if}-->		

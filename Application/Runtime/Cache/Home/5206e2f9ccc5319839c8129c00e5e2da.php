...
/index.php/czlt/zhmm<br>/index.php/Home/Czlt
...
<td>
<input type="text" id="cs893" name="cs893" autocomplete="off" size="25" tabindex="1" class="px" required /><br /><em id="emailmore">&nbsp;</em>
...
<!--http://www.bbs.com/index.php/Home/Czlt/yzm验证码start-->
<div id='yzma'>
    <img src="" onclick="gai()" width="80"  height='25' id='yzm'/> 
</div>

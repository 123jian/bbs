...
<head>
	<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />
		<link rel="stylesheet" href="/Publichoutai/css/public.css" />
	<title></title>
</head>
<body>
    <form action="<?php echo U('Admin/shizi/insert_shizi');?>" method="post" enctype="multipart/form-data">
		<table class="table">
			<tr>
			...
			<tr>
				<td>教师名称</td>
				<td>
					<input type="text" name="s_name" class="title"/>
				</td>
			</tr>
                        <tr>
				<td>教师头像</td>
			...
			<tr>
				<td>描述</td>
				<td>
					<textarea id="editor_id" name="s_content" style="width:700px;height:300px;"></textarea>
				</td>
			</tr>
                        <tr>
				<td>是否显示</td>

...
<body>
	<table class="table">
		...
		<tr>
			...
			<td>
				<a href="/Tp3.2/bbs/index.php/Admin/Huiyuan/edit_article_show/text_id/<?php echo $val['text_id']?>">[编辑]</a>
                                <a href="/Tp3.2/bbs/index.php/Admin/Huiyuan/article_delete/text_id/<?php echo $val['text_id']?>" class="del">[删除]</a>
			</td>
		</tr>
            <?php }?>
	</table>
